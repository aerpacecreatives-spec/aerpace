    ...
    <section className="aershield-section">
      ...
      <div className="lg:w-1/2 aershield-content ps-10 mt-24 lg:mt-0">
        <div className="max-w-xl">
          ...
          <p>
            aerShield is engineered for resilience. Adaptive armor,
            reactive protection, and unmatched durability.
          </p>
          <p>
            When pressure rises, aerShield stands unbreakable —
            built to absorb, adapt, and overcome.
          </p>

          {/* Third image under text */}
          <div className="aershield-3 mt-10">
            <img src="/images/aershield-3.webp" />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-6 img-box lg:w-1/2 mt-24 lg:mt-0">
        <div className="aershield-1">
          <img src="/images/aershield-1.webp" />
        </div>

        <div className="aershield-2">
          <img src="/images/aershield-2.webp" />
        </div>
      </div>
    </section>
  );
